...
mod.optionsArgs = {
  ...
  bossrewards_eye = {
    type = "group",
    name = Encounters:GetInstance(616).name,
    order = 29,
    set = SetEP,
    get = GetEP,
    args = {
      kill_1 = EncounterKillPlate(1094, 1),
      wipe_1 = EncounterWipePlate(1094, 1),
    }
  },
  bossrewards_obsidian = {
    type = "group",
    name = Encounters:GetInstance(615).name,
    order = 28,
    set = SetEP,
    get = GetEP,
    args = {
      kill_1 = EncounterKillPlate(1090, 1),
      wipe_1 = EncounterWipePlate(1090, 1),
      kill_2 = EncounterKillPlate(1091, 2),
      wipe_2 = EncounterWipePlate(1091, 2),
      kill_3 = EncounterKillPlate(1092, 3),
      wipe_3 = EncounterWipePlate(1092, 3),
      kill_4 = EncounterKillPlate(1093, 4),
      wipe_4 = EncounterWipePlate(1093, 4),
    }
  },
  bossrewards_ulduar = {
    type = "group",
    name = Encounters:GetInstance(603).name,
    order = 30,
    set = SetEP,
    get = GetEP,
    args = {
      kill_1 = EncounterKillPlate(1130, 1),
      wipe_1 = EncounterWipePlate(1130, 1),
      kill_2 = EncounterKillPlate(1131, 2),
      wipe_2 = EncounterWipePlate(1131, 2),
      kill_3 = EncounterKillPlate(1132, 3),
      wipe_3 = EncounterWipePlate(1132, 3),
      kill_4 = EncounterKillPlate(1133, 4),
      wipe_4 = EncounterWipePlate(1133, 4),
      kill_5 = EncounterKillPlate(1134, 5),
      wipe_5 = EncounterWipePlate(1134, 5),
      kill_6 = EncounterKillPlate(1135, 6),
      wipe_6 = EncounterWipePlate(1135, 6),
      kill_7 = EncounterKillPlate(1136, 7),
      wipe_7 = EncounterWipePlate(1136, 7),
      kill_8 = EncounterKillPlate(1137, 8),
      wipe_8 = EncounterWipePlate(1137, 8),
      kill_9 = EncounterKillPlate(1138, 9),
      wipe_9 = EncounterWipePlate(1138, 9),
      kill_10 = EncounterKillPlate(1139, 10),
      wipe_10 = EncounterWipePlate(1139, 10),
      kill_11 = EncounterKillPlate(1140, 11),
      wipe_11 = EncounterWipePlate(1140, 11),
      kill_12 = EncounterKillPlate(1141, 12),
      wipe_12 = EncounterWipePlate(1141, 12),
      kill_13 = EncounterKillPlate(1142, 13),
      wipe_13 = EncounterWipePlate(1142, 13),
      kill_14 = EncounterKillPlate(1143, 14),
      wipe_14 = EncounterWipePlate(1143, 14),
    }
  },
  bossrewards_toc = {
    type = "group",
    name = Encounters:GetInstance(649).name,
    order = 32,
    set = SetEP,
    get = GetEP,
    args = {
      kill_1 = EncounterKillPlate(1085, 1),
      wipe_1 = EncounterWipePlate(1085, 1),
      kill_2 = EncounterKillPlate(1086, 2),
      wipe_2 = EncounterWipePlate(1086, 2),
      kill_3 = EncounterKillPlate(1087, 3),
      wipe_3 = EncounterWipePlate(1087, 3),
      kill_4 = EncounterKillPlate(1088, 4),
      wipe_4 = EncounterWipePlate(1088, 4),
      kill_5 = EncounterKillPlate(1089, 5),
      wipe_5 = EncounterWipePlate(1089, 5),
    }
  },
  bossrewards_icc = {
    type = "group",
    name = Encounters:GetInstance(631).name,
    order = 33,
    set = SetEP,
    get = GetEP,
    args = {
      kill_1 = EncounterKillPlate(1095, 1),
      wipe_1 = EncounterWipePlate(1095, 1),
      kill_2 = EncounterKillPlate(1096, 2),
      wipe_2 = EncounterWipePlate(1096, 2),
      kill_3 = EncounterKillPlate(1097, 3),
      wipe_3 = EncounterWipePlate(1097, 3),
      kill_4 = EncounterKillPlate(1098, 4),
      wipe_4 = EncounterWipePlate(1098, 4),
      kill_5 = EncounterKillPlate(1099, 5),
      wipe_5 = EncounterWipePlate(1099, 5),
      kill_6 = EncounterKillPlate(1100, 6),
      wipe_6 = EncounterWipePlate(1100, 6),
      kill_7 = EncounterKillPlate(1101, 7),
      wipe_7 = EncounterWipePlate(1101, 7),
      kill_8 = EncounterKillPlate(1102, 8),
      wipe_8 = EncounterWipePlate(1102, 8),
      kill_9 = EncounterKillPlate(1103, 9),
      wipe_9 = EncounterWipePlate(1103, 9),
      kill_10 = EncounterKillPlate(1104, 10),
      wipe_10 = EncounterWipePlate(1104, 10),
      kill_11 = EncounterKillPlate(1105, 11),
      wipe_11 = EncounterWipePlate(1105, 11),
      kill_12 = EncounterKillPlate(1106, 12),
      wipe_12 = EncounterWipePlate(1106, 12),
    }
  },
}
